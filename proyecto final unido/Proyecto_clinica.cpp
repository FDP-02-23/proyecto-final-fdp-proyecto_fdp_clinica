...
{
    cout <<endl
         << "     -----Las especialidades con las que dispone nuestra clinica son-----        " << endl
...
void inf_clinica()
{
    cout <<endl << "Direccion: Calle las Oscuranas, Colonia miramonte, San Salvador." << endl;
...
int main()
{
    ...
    especialidades[0] = "Es el nivel de atencion medica principal, la cual es importante para la deteccion, tratamiento y prevencion de las enfermedades cronicas.";
        ...
        case 1:
            ...
            do
            {
                ...
                case 1:
                    ...
                    cin >> cita.edad;
                    // Telefono
                    cout << "Ingresar telefono del paciente (8 digitos, todo unido): ";
                    cin >> cita.telefono;
                    // Mes
                    ...
                    do
                    {
                        ...
                        else if ((cita.mes == 1) || (cita.mes == 3) || (cita.mes == 5) || (cita.mes == 7) || (cita.mes == 8) || (cita.mes == 9) || (cita.mes == 10) || (cita.mes == 12) && (cita.dia <= 31))
                        {
